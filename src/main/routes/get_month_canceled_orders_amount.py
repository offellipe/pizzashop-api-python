...
@metrics_blueprint.route("/metrics/month-canceled-orders-amount", methods=["GET"]) # noqa
@authenticate_user
def get_month_canceled_orders_amount():
    try:
        ...
        with db_connection_handler() as session:
            ...
            orders_per_month = order_repository.get_canceled_orders_per_month(
